...
class TVA_Topic extends TVA_Options_List {
	...
	public static function get_items( $as_array = false ) {
		...
		if ( empty( $items ) ) {
			$items = static::get_defaults( $as_array );
		}
	...
	/**
	 * @return string URL for the image set as icon
	 */
	public function icon_url() {

		return $this->svg_icon ? $this->svg_icon : TVA_Const::get_default_course_icon_url();
	}
	 ...
	 *
	 * @return TVA_Topic[]|array
	 */
	public static function get_defaults( $as_array = false ) {
