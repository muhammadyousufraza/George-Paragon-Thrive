...
class TVA_Course_Chapters_Structure_Builder extends TVA_Course_Structure_Builder {

	/**
	 * Fetch all chapters from DB at course level
	 *
	 * @return TVA_Post[]
	 */
	public function get_posts() {
		...
		$args = array(
			...
			'meta_key'       => array( 'tva_lesson_order' ),
