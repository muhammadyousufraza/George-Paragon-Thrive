...
class Assessment_Passed extends Trigger {

	public static function get_id() {
		return 'thrive/assessment_passed';
	}
	...
	public static function get_name() {
		return 'Assessment has been marked and passed';
	}

	public static function get_description() {
		return 'Fires when an assessment is marked as passed';
	}
