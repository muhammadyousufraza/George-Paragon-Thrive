...
class Assessment_Submitted extends Trigger {

	public static function get_id() {
		return 'thrive/assessment_submitted';
	}
	...
	public static function get_name() {
		return 'User submits an assessment';
	}

	public static function get_description() {
		return 'Fires when an assessment is submitted';
	}
