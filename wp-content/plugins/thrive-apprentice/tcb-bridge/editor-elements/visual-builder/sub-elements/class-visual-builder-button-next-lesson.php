...
/**
 * Class Visual_Builder_Button_Next_Lesson
 *
 * @package  TVA\Architect\Visual_Builder\Elements
 * @project  : thrive-apprentice
 */
class Visual_Builder_Button_Next_Lesson extends Abstract_Visual_Builder_Element {
	/**
	 * @var string
	 */
	protected $_tag = 'visual_builder_button_next_lesson';
	...
	public function name() {
		return __( 'Next Lesson', 'thrive-apprentice' );
	}
...
return new Visual_Builder_Button_Next_Lesson();
