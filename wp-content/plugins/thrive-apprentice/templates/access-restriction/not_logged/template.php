<?php /* HTML Content should be copy-pasted from the editor */ ?>
<div class="thrv_wrapper thrv_contentbox_shortcode thrv-content-box tve-elem-default-pad" data-css="tve-u-1766b8fa8f8" style="">
	...
	<div class="tve-cb"><div class="thrv_wrapper tve_image_caption" data-css="tve-u-176840b94a6" style=""><span class="tve_image_frame"><img class="tve_image wp-image-2567" alt="" data-id="2567" width="127" data-init-width="127" height="127" data-init-height="127" title="group-4" loading="lazy" src="<?php echo tve_dash_url_no_protocol( TVA_Const::plugin_url( 'img/not-logged.svg' ) ); ?>" data-width="127" data-height="127" data-link-wrap="true"></span></div><div class="thrv_wrapper thrv_text_element" style="--tve-border-width:2px; border-top: 2px solid rgba(0, 0, 0, 0.03) !important;" data-css="tve-u-1768408dffc"><h4 class="" style="margin: 0; padding: 0; text-align: center;">You must be logged in to access this course</h4><p style="margin: 0; padding: 0; text-align: center;">This course is only available for registered users.</p></div><div class="thrv_wrapper thrv-button thrv-button-v2 tcb-local-vars-root" data-css="tve-u-1766b911f39">
			...
			<a href="[tva_dynamic_link id=login]" class="tcb-button-link tcb-plain-text tve-dynamic-link" data-shortcode-id="login" data-dynamic-link="tva_dynamic_link">
