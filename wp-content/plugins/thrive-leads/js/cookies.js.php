...
<script type="text/javascript">
	...
	_now.setTime( _now.getTime() + (<?php echo (int) $cookie['expires']; ?> * 24 * 3600 * 1000 ));
	sExpires = _now.toUTCString();
	document.cookie = encodeURIComponent(<?php echo json_encode( $key ) ?>) + '=' + encodeURIComponent(<?php echo json_encode( $cookie['value'] ) ?>) +	'; expires = ' + sExpires + '; path = /';
	<?php endforeach ?>
</script>
