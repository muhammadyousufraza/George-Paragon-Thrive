...
?>
<div class="thrv_ult_widget thrv_wrapper tve_no_drag tve_no_icons tve_element_hover tvu_set_15 tve_orange">
	<div class="tve-ult-widget-content tve_editor_main_content">
		...
		<div class="thrv_wrapper thrv-button tcb-quotes" style="margin-top: 40px;">
